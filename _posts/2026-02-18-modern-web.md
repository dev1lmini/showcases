...
description: "A next-generation dining and ordering platform"
date: 2026-02-18
...
<video src="demos/full-experience.mp4" autoplay loop muted controls></video>
...
<video src="demos/search.mp4" autoplay loop muted controls></video>
...
<video src="demos/place.mp4" autoplay loop muted controls></video>
...
<video src="demos/sections.mov" autoplay loop muted controls></video>
<p class="video-caption">Menu sections synchronized with scrolling.</p>
<video src="demos/sections2.mov" autoplay loop muted controls></video>
<p class="video-caption">Alternate view of synchronized sections.</p>
<video src="demos/section3.mp4" autoplay loop muted controls></video>
...
<video src="demos/menu.mov" autoplay loop muted controls></video>
<p class="video-caption">Menu interaction focused on ultra-fast selection.</p>
<video src="demos/order2.mov" autoplay loop muted controls></video>
...
<video src="demos/order.mp4"  autoplay loop muted controls></video>
<p class="video-caption">Order creation process from cart to confirmation.</p>
<video src="demos/order3.mov" autoplay loop muted controls></video>
...
<video src="demos/eatfeed.mp4" autoplay loop muted controls></video>
